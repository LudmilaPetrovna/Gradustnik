...
(MumbleProto__UserState__VolumeAdjustment         *message){
	static const MumbleProto__UserState__VolumeAdjustment init_value=MUMBLE_PROTO__USER_STATE__VOLUME_ADJUSTMENT__INIT;
	*message=init_value;
}
...
(MumbleProto__PluginDataTransmission         *message){
	static const MumbleProto__PluginDataTransmission init_value=MUMBLE_PROTO__PLUGIN_DATA_TRANSMISSION__INIT;
	*message=init_value;
}
size_t mumble_proto__plugin_data_transmission__get_packed_size
(const MumbleProto__PluginDataTransmission *message){
	assert(message->base.descriptor == &mumble_proto__plugin_data_transmission__descriptor);
	return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
(ProtobufCAllocator  *allocator,
	size_t               len,
	const uint8_t       *data){
	return (MumbleProto__PluginDataTransmission *)
	protobuf_c_message_unpack (&mumble_proto__plugin_data_transmission__descriptor,
	allocator, len, data);
}
...
static const ProtobufCFieldDescriptor mumble_proto__version__field_descriptors[5] =
{
	{
		"version_v1",
		1,
		...
		offsetof(MumbleProto__Version, has_version_v1),
		offsetof(MumbleProto__Version, version_v1),
		NULL,
		NULL,
		0,             /* flags */
	...
	},
	{
		...
		offsetof(MumbleProto__Version, has_version_v2),
		offsetof(MumbleProto__Version, version_v2),
		NULL,
		NULL,
		0,             /* flags */
		0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned mumble_proto__version__field_indices_by_name[] = {
	...
	1,   /* field[1] = release */
	0,   /* field[0] = version_v1 */
	4,   /* field[4] = version_v2 */
};
...
static const int32_t mumble_proto__authenticate__client_type__default_value=0;
static const ProtobufCFieldDescriptor mumble_proto__authenticate__field_descriptors[6] =
{
	{
		"username",
		1,
	...
	},
	{
		...
		PROTOBUF_C_LABEL_OPTIONAL,
		PROTOBUF_C_TYPE_INT32,
		offsetof(MumbleProto__Authenticate, has_client_type),
		offsetof(MumbleProto__Authenticate, client_type),
		NULL,
		&mumble_proto__authenticate__client_type__default_value,
		0,             /* flags */
		0,NULL,NULL    /* reserved1,reserved2, etc */
	},
};
...
static const ProtobufCFieldDescriptor mumble_proto__channel_state__field_descriptors[13] =
{
	{
		"channel_id",
		1,
	...
	},
	{
		...
		PROTOBUF_C_LABEL_OPTIONAL,
		PROTOBUF_C_TYPE_BOOL,
		offsetof(MumbleProto__ChannelState, has_is_enter_restricted),
		offsetof(MumbleProto__ChannelState, is_enter_restricted),
		NULL,
		NULL,
		0,             /* flags */
		0,NULL,NULL    /* reserved1,reserved2, etc */
	},
	{
		...
		PROTOBUF_C_LABEL_OPTIONAL,
		PROTOBUF_C_TYPE_BOOL,
		offsetof(MumbleProto__ChannelState, has_can_enter),
		offsetof(MumbleProto__ChannelState, can_enter),
		NULL,
		NULL,
		0,             /* flags */
		0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned mumble_proto__channel_state__field_indices_by_name[] = {
	12,   /* field[12] = can_enter */
	0,   /* field[0] = channel_id */
	4,   /* field[4] = description */
	9,   /* field[9] = description_hash */
	11,   /* field[11] = is_enter_restricted */
	3,   /* field[3] = links */
	5,   /* field[5] = links_add */
...
static const ProtobufCFieldDescriptor mumble_proto__user_state__volume_adjustment__field_descriptors[2] =
{
	{
		"listening_channel",
		1,
		PROTOBUF_C_LABEL_OPTIONAL,
		PROTOBUF_C_TYPE_UINT32,
		offsetof(MumbleProto__UserState__VolumeAdjustment, has_listening_channel),
		offsetof(MumbleProto__UserState__VolumeAdjustment, listening_channel),
		NULL,
		NULL,
		0,             /* flags */
		0,NULL,NULL    /* reserved1,reserved2, etc */
	},
	{
		...
		PROTOBUF_C_LABEL_OPTIONAL,
		PROTOBUF_C_TYPE_FLOAT,
		offsetof(MumbleProto__UserState__VolumeAdjustment, has_volume_adjustment),
		offsetof(MumbleProto__UserState__VolumeAdjustment, volume_adjustment),
		NULL,
		NULL,
		0,             /* flags */
		0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned mumble_proto__user_state__volume_adjustment__field_indices_by_name[] = {
	0,   /* field[0] = listening_channel */
	1,   /* field[1] = volume_adjustment */
};
static const ProtobufCIntRange mumble_proto__user_state__volume_adjustment__number_ranges[1 + 1] =
{
	{ 1, 0 },
	{ 0, 2 }
};
const ProtobufCMessageDescriptor mumble_proto__user_state__volume_adjustment__descriptor={
	PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC,
	"MumbleProto.UserState.VolumeAdjustment",
	"VolumeAdjustment",
	"MumbleProto__UserState__VolumeAdjustment",
	"MumbleProto",
	sizeof(MumbleProto__UserState__VolumeAdjustment),
	2,
	mumble_proto__user_state__volume_adjustment__field_descriptors,
	mumble_proto__user_state__volume_adjustment__field_indices_by_name,
	1,  mumble_proto__user_state__volume_adjustment__number_ranges,
	(ProtobufCMessageInit) mumble_proto__user_state__volume_adjustment__init,
	NULL,NULL,NULL    /* reserved[123] */
};
static const ProtobufCFieldDescriptor mumble_proto__user_state__field_descriptors[23] =
{
	{
		"session",
		1,
	...
	},
	{
		...
		PROTOBUF_C_LABEL_REPEATED,
		PROTOBUF_C_TYPE_STRING,
		offsetof(MumbleProto__UserState, n_temporary_access_tokens),
		offsetof(MumbleProto__UserState, temporary_access_tokens),
		NULL,
		NULL,
		0,             /* flags */
		0,NULL,NULL    /* reserved1,reserved2, etc */
	},
	{
		...
		PROTOBUF_C_LABEL_REPEATED,
		PROTOBUF_C_TYPE_UINT32,
		offsetof(MumbleProto__UserState, n_listening_channel_add),
		offsetof(MumbleProto__UserState, listening_channel_add),
		NULL,
		NULL,
		0,             /* flags */
		0,NULL,NULL    /* reserved1,reserved2, etc */
	},
	{
		...
		PROTOBUF_C_LABEL_REPEATED,
		PROTOBUF_C_TYPE_UINT32,
		offsetof(MumbleProto__UserState, n_listening_channel_remove),
		offsetof(MumbleProto__UserState, listening_channel_remove),
		NULL,
		NULL,
		0,             /* flags */
		0,NULL,NULL    /* reserved1,reserved2, etc */
	},
	{
		...
		offsetof(MumbleProto__UserState, n_listening_volume_adjustment),
		offsetof(MumbleProto__UserState, listening_volume_adjustment),
		&mumble_proto__user_state__volume_adjustment__descriptor,
		NULL,
		0,             /* flags */
		0,NULL,NULL    /* reserved1,reserved2, etc */
	},
...
static const unsigned mumble_proto__user_state__field_indices_by_name[] = {
	...
	6,   /* field[6] = deaf */
	14,   /* field[14] = hash */
	20,   /* field[20] = listening_channel_add */
	21,   /* field[21] = listening_channel_remove */
	22,   /* field[22] = listening_volume_adjustment */
	5,   /* field[5] = mute */
	2,   /* field[2] = name */
	...
	0,   /* field[0] = session */
	7,   /* field[7] = suppress */
	19,   /* field[19] = temporary_access_tokens */
	10,   /* field[10] = texture */
...
static const ProtobufCEnumValue mumble_proto__permission_denied__deny_type__enum_values_by_number[14] =
{
	...
	{ "ChannelCountLimit", "MUMBLE_PROTO__PERMISSION_DENIED__DENY_TYPE__ChannelCountLimit", 11 },
	{ "ChannelListenerLimit", "MUMBLE_PROTO__PERMISSION_DENIED__DENY_TYPE__ChannelListenerLimit", 12 },
	{ "UserListenerLimit", "MUMBLE_PROTO__PERMISSION_DENIED__DENY_TYPE__UserListenerLimit", 13 },
};
static const ProtobufCIntRange mumble_proto__permission_denied__deny_type__value_ranges[] = {
	{0, 0},{0, 14}
};
static const ProtobufCEnumValueIndex mumble_proto__permission_denied__deny_type__enum_values_by_name[14] =
{
...
static const ProtobufCFieldDescriptor mumble_proto__server_config__field_descriptors[7] =
{
	{
		"max_bandwidth",
		1,
	...
	},
	{
		...
		PROTOBUF_C_LABEL_OPTIONAL,
		PROTOBUF_C_TYPE_BOOL,
		offsetof(MumbleProto__ServerConfig, has_recording_allowed),
		offsetof(MumbleProto__ServerConfig, recording_allowed),
		NULL,
		NULL,
		0,             /* flags */
		0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const ProtobufCFieldDescriptor mumble_proto__suggest_config__field_descriptors[4] =
{
	{
		"version_v1",
		1,
		PROTOBUF_C_LABEL_OPTIONAL,
		PROTOBUF_C_TYPE_UINT32,
		offsetof(MumbleProto__SuggestConfig, has_version_v1),
		offsetof(MumbleProto__SuggestConfig, version_v1),
		NULL,
		NULL,
		0,             /* flags */
		0,NULL,NULL    /* reserved1,reserved2, etc */
	...
	},
	{
		...
		PROTOBUF_C_LABEL_OPTIONAL,
		PROTOBUF_C_TYPE_UINT64,
		offsetof(MumbleProto__SuggestConfig, has_version_v2),
		offsetof(MumbleProto__SuggestConfig, version_v2),
		NULL,
		NULL,
		0,             /* flags */
		0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const ProtobufCFieldDescriptor mumble_proto__plugin_data_transmission__field_descriptors[4] =
{
	{
		"senderSession",
		1,
		PROTOBUF_C_LABEL_OPTIONAL,
		PROTOBUF_C_TYPE_UINT32,
		offsetof(MumbleProto__PluginDataTransmission, has_sendersession),
		offsetof(MumbleProto__PluginDataTransmission, sendersession),
		NULL,
		NULL,
		0,             /* flags */
		0,NULL,NULL    /* reserved1,reserved2, etc */
	},
	{
		...
		PROTOBUF_C_LABEL_REPEATED,
		PROTOBUF_C_TYPE_UINT32,
		offsetof(MumbleProto__PluginDataTransmission, n_receiversessions),
		offsetof(MumbleProto__PluginDataTransmission, receiversessions),
		NULL,
		NULL,
	...
	},
	{
		...
		PROTOBUF_C_LABEL_OPTIONAL,
		PROTOBUF_C_TYPE_BYTES,
		offsetof(MumbleProto__PluginDataTransmission, has_data),
		offsetof(MumbleProto__PluginDataTransmission, data),
		NULL,
		NULL,
		0,             /* flags */
		0,NULL,NULL    /* reserved1,reserved2, etc */
	},
	{
		...
		PROTOBUF_C_TYPE_STRING,
		0,   /* quantifier_offset */
		offsetof(MumbleProto__PluginDataTransmission, dataid),
		NULL,
		NULL,
		0,             /* flags */
		0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned mumble_proto__plugin_data_transmission__field_indices_by_name[] = {
	2,   /* field[2] = data */
	3,   /* field[3] = dataID */
	1,   /* field[1] = receiverSessions */
	0,   /* field[0] = senderSession */
};
static const ProtobufCIntRange mumble_proto__plugin_data_transmission__number_ranges[1 + 1] =
{
	{ 1, 0 },
	{ 0, 4 }
};
const ProtobufCMessageDescriptor mumble_proto__plugin_data_transmission__descriptor={
	PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC,
	"MumbleProto.PluginDataTransmission",
	"PluginDataTransmission",
	"MumbleProto__PluginDataTransmission",
	"MumbleProto",
	sizeof(MumbleProto__PluginDataTransmission),
	4,
	mumble_proto__plugin_data_transmission__field_descriptors,
	mumble_proto__plugin_data_transmission__field_indices_by_name,
	1,  mumble_proto__plugin_data_transmission__number_ranges,
	(ProtobufCMessageInit) mumble_proto__plugin_data_transmission__init,
	NULL,NULL,NULL    /* reserved[123] */
};
